...
const ExamApprovalFormDrawer: React.FC<ExamApprovalFormDrawerProps> = ({
  ...
  const getQuestionTypeName = (questionTypeId: number) => {
    ...
    return questionType ? questionType.name : 'N/A';
  };
      ...
      {examData ? (
        <Tabs
          ...
          items={[
                ...
                >
                  ...
                  <Card title="Thông tin cơ bản" size="small">
                    <div style={{ display: 'grid', gap: '12px' }}>
                      ...
                      <div>
                        <Text strong>Lĩnh vực:</Text> {getFieldName(examData.fieldId)}
                      </div>
                      <div>
                        <Text strong>Cấp độ:</Text> {getLevelName(examData.levelId)}
                      </div>
                      <div>
                      ...
                      <div>
                        ...
                        <div style={{ marginTop: '8px' }}>
                          {examData.questionTypeIds && examData.questionTypeIds.length > 0 ? (
                            <div style={{ display: 'flex', flexWrap: 'wrap', gap: '4px' }}>
                              {examData.questionTypeIds.map(questionTypeId => (
                                <Tag key={questionTypeId} color="green">
            ...
            {
              key: '2',
              label: `Danh sách câu hỏi (${examData?.questions?.length || 0})`,
              children: (
