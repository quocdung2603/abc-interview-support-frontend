...
const FieldPreviewDrawer: React.FC<PreviewDrawerProps> = ({
  visible,
  onClose,
  data,
}) => {
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
          ...
          >
            ...
            >
              ...
              <Descriptions.Item label="Tên lĩnh vực">
...
export default FieldPreviewDrawer;
