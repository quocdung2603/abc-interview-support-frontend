...
const ChallengeBanner: React.FC = () => {
  return (
    <div className="bg-section-alternate py-12 md:py-16 animate-fade-in overflow-hidden">
      ...
      <div className="container-center relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="text-xl md:text-2xl font-bold text-gray-900 leading-tight mb-4 animate-fade-in-up">
            Bắt đầu thử thách với trắc nghiệm từ{' '}
            <span className="text-gradient-primary">ABCQuiz!</span>
          </h1>

          <div className="space-y-3 mb-8 animate-slide-in-left">
          ...
          <div className="flex flex-col md:flex-row justify-center gap-4 animate-slide-in-right">
            <button className="btn-secondary px-6 py-3 text-base font-semibold">
              📚 THI THEO ĐỀ
            </button>
            <button className="btn-accent px-6 py-3 text-base font-semibold">
              🎲 THI NGẪU NHIÊN
            </button>
          </div>
        </div>
