    ...
    <div className="bg-white py-12 md:py-16 animate-fade-in">
      <div className="container-center">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-8">
          {/* Image illustration */}
          <div className="md:w-1/2 mb-6 md:mb-0 animate-fade-in-up">
            <div className="card-elevated overflow-hidden">
              <img
                src="https://picsum.photos/500/350?random=10"
          ...
          {/* Content */}
          <div className="md:w-1/2 md:pl-6 flex flex-col gap-6 animate-fade-in-up">
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                <CheckCircleOutlined className="text-sky-600 text-xl mr-3 mt-1" />
