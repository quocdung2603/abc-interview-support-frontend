        ...
        <div className="space-y-3">
          {answers.map((answer) => (
            <label
              ...
              style={{
                borderColor: selectedAnswers.includes(answer.answerId)
                  ? '#0ea5e9'
                  : '#e2e8f0',
                backgroundColor: selectedAnswers.includes(answer.answerId)
                  ? '#f0f9ff'
                  : 'white',
              }}
            >
              <input
                ...
                onChange={() => handleAnswerToggle(answer.answerId)}
